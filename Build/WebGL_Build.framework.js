...
var ASM_CONSTS = {
  2935824: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2935885: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2935949: function() {return Module.webglContextAttributes.powerPreference;},  
 2936007: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2936062: function($0) {performance.now = function() { return $0; };},  
 2936110: function($0) {performance.now = function() { return $0; };},  
 2936158: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _download(url, name, opts) {
          var xhr = new XMLHttpRequest();
          xhr.open('GET', url);
...
var asmLibraryArg = {
  ...
  "UNITY_IS_SUPPORTED": _UNITY_IS_SUPPORTED,
  "UNITY_SAVE": _UNITY_SAVE,
  "UNITY_SAVE_BYTEARRAY": _UNITY_SAVE_BYTEARRAY,
